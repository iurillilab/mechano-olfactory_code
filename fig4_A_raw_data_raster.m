clear; clc; close all;
[~, mouseNameList, dataPathPrefixList] = get_all_deafferented_mice('paola');
figure(101)
%%
mn = 1;
oi = 51;
for mn = 1: length(mouseNameList)
    ...
    generalOutputDir = fullfile('supp_bulbectomized_tuning_newCode', 'rasterRAWDATA_examples', 'unsorted_M1');
    plotDir = fullfile(final_figs_path('paola'), generalOutputDir);
