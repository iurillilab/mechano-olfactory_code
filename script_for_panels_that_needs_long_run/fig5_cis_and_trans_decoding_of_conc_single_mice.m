...
for mn = 1 : length(mouseNameList)
    ...
    for perm = 1 : numberOfBalanceSampling
        ...
        [fSpaceCell, fSpaceLbelsCell] =...
            get_aSample(dataPathPrefix, mouseNameList(mn),....
    ...
    saveDir = fullfile(final_figs_path('beast1'),...
        'Fig5_cic_and_trans_decoding_of_conc_data_single_mice',mouseName);
    if ~exist(saveDir , 'dir')
       mkdir(saveDir)
    end
    %%
    save(fullfile(saveDir,...
        sprintf('Fig5_cic_and_trans_decoding_of_conc_data_mouse%d.mat', mn)),...
        'fullSpaceDecodingAcc_R_o1',...
        'fullSpaceDecodingAcc_S_o1',...
        'fullSpaceDecodingAcc_Rtrain_Stest_o1',...
        'fullSpaceDecodingAcc_Strain_Rtest_o1',...
